...
def create_introspect_agent(
    ...
    return LlmAgent(
        ...
        instruction=(
            ...
            "- Introspect Notion databases (if sdc-toolset-notion installed)\n"
            "- Introspect Google Sheets (if sdc-toolset-sheets installed)\n"
            "- Introspect Airtable bases (if sdc-toolset-airtable installed)\n\n"
